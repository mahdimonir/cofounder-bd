...
export async function POST(req: Request) {
    try {
        ...
        if (isRateLimited(`stylehunt_checkout_ip_${ip}`, { limit: 5, windowMs: 15 * 60 * 1000 })) {
        ...
        if (isRateLimited(`stylehunt_checkout_phone_${formattedPhone}`, { limit: 2, windowMs: 60 * 60 * 1000 })) {
